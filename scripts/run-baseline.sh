...
time src/main-opt --mode baseline --synth-database $SYNTH_DB --test-database $TEST_DB --input $1 < $CONFIG_FILE > "$TEMP_F"

praat scripts/concat.praat $TEMP_F $(pwd)/baseline.wav
